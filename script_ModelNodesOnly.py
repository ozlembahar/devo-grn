...
if __name__ == '__main__':
    ...
    nodes = ["en", "ind", "vnd", "ac", "Dr", "gsb", "Wg", "svp", 'Hh','hkb', 'Gro', 'Pan', 'Ptc', 'Smo', 'slp1', 'gcm', 'gcm2', 'Pnt']
    all_tf_names = load_tf_names("./data/allTFs_dmel.txt") # Derive list of Transcription Factors(TF) for Drosophila
    tf_names = [tf fot tf in all_tf_names if tf in nodes]
