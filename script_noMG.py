...
if __name__ == '__main__':
    ...
    ex_matrix = pd.read_csv("./data/expression_mat_noMG.csv", index_col=0)  # load count matrix 
    ...
    for i in range(0, n): 
        ...
        modules = list(modules_from_adjacencies(adjacencies, ex_matrix, keep_only_activating = False)) # module generation - candidate regulons from TF-target gene interactions 
        # save to files:
